function getAudio()
	...
	hitSound = love.audio.newSource("audio/sfx/hit.wav", "static")
	swingSound = love.audio.newSource("audio/sfx/swing.wav", "static")
	shootSound = love.audio.newSource("audio/sfx/shoot.wav", "static")
	coinSound = love.audio.newSource("audio/sfx/coin.wav", "static")
	bossDieSound = love.audio.newSource("audio/sfx/bossDie.wav", "static")
	enemyDieSound = love.audio.newSource("audio/sfx/enemyDie.wav", "static")
	thudSound = love.audio.newSource("audio/sfx/thud.wav", "static")
	teleportSound = love.audio.newSource("audio/sfx/teleport.wav", "static")
	...
	table.insert(sfxList, hitSound)
	table.insert(sfxList, swingSound)
	table.insert(sfxList, shootSound)
	table.insert(sfxList, coinSound)
	table.insert(sfxList, bossDieSound)
	table.insert(sfxList, enemyDieSound)
	table.insert(sfxList, thudSound)
	table.insert(sfxList, teleportSound)
